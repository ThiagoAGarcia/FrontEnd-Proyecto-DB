export default function NotificationUser({name, date}) {
  ...
  return (
    <div className="flex items-center justify-between rounded-lg px-3 py-2">
      <div className="flex flex-col">
        ...
        {/* Aquí mostramos la fecha formateada */}
      ...
      <div className="flex items-center gap-2">
        ...
        <button className="w-8 h-8 flex items-center justify-center rounded-full bg-emerald-100 text-emerald-600 hover:bg-emerald-200 transition">
