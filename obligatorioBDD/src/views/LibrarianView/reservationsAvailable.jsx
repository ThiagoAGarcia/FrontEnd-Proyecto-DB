            ...
            <div className="sm:flex justify-between items-center w-full sm:pb-3">
                ...
                <div className="py-3 sm:py-0 px-1 sm:px-0 sm:p-4 text-gray-300 sm:w-1/2">
                    <div className="relative flex">
                        <input type="text" className="bg-white h-10 flex px-5 w-full rounded-full text-sm focus:outline-none border-2 placeholder-gray-400 border-gray-500" placeholder="Buscar reservas" />
                    </div>
                </div>
            </div>
                            ...
                            {reservationsToday.map((reservation) => (
                                <li key={reservation.studyGroupId}>
                                    <Data reserva={reservation}>
                                        ...
                                        <button onClick={() => handleNewManagedReservation(reservation) }title="Aceptar reserva" className="border-1 rounded-md sm:mx-1 px-2 mx-0.5 p-0.5 bg-green-100 cursor-pointer hover:bg-green-50 transition-colors">
