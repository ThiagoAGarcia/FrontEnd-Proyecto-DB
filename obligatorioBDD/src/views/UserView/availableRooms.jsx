              ...
              <div className="p-4 bg-gray-100 rounded-xl shadow border border-gray-200">
                <div className="w-full flex flex-col gap-6">
                  ...
                  {salasUnicas.map((sala, index) => (
                    <details
                      key={index}
                      className="w-full bg-white shadow-md rounded-xl border border-gray-200 open:shadow-lg transition-all">
                      ...
                      <ul className="w-full overflow-auto scrollbar mt-1 px-2 pb-3">
                        {salas
                          .filter((r) => r.studyRoom === sala.studyRoom)
                          .map((turno, i) => (
                            <div
                              key={i}
                              ...
                              <div className="hidden lg:flex justify-between items-center text-lg">
                                <div
                                  className={`w-1/2 text-center border-r-2 font-semibold border-gray-300 
                                                                ${
                                                                  turno.status ===
                                                                  'Ocupado'
                                                                    ? 'text-red-500'
